...
def make_w2v_embeddings(train, embedding_dim=300, empty_w2v=False):
    vocabs = {}
    vocabs_cnt = 0
    ...
    for index, row in train.iterrows():
        ...
        # Iterate through the text of both sentence of the row
        for sentence in ['sentence1', 'sentence2']:

            s2n = []  # s2n -> sentence numbers representation
                       
            train.at[index, sentence] = s2n
...
def split_and_zero_padding(train, max_seq_length):
    # Split to dicts
    X = {'left': train['sentence1'], 'right': train['sentence2']}
